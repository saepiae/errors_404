...
public class GroupStructureController {
    ...
    public String addGroup2(HttpServletRequest request,
                            @RequestAttribute long student_item,
                            @RequestAttribute long group_item,Model model ) {

        Group group = new Group(student_item,group_item);
        service.add(group);
    ...
    public String updateGroup2(HttpServletRequest request,
                               ...
                               @RequestAttribute long student_item,
                               @RequestAttribute long group_item, Model model) {
        Group group = new Group(id, student_item, group_item);
